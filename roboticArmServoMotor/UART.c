...
void UART_Init(void){
  ...
  UART1_IBRD_R = 81;                    // IBRD = int(50,000,000 / (16 * 38400)) = int(81.38020833)    325.520833
  UART1_FBRD_R = 24;                     // FBRD = int(0.38020833 * 64 + 0.05) = int(24)						33
...
void UART_Init(void) {
  ...
  UART1_CTL_R &= ~UART_CTL_UARTEN;      // disable UART
  UART1_IBRD_R = 325;                    // IBRD = int(50,000,000 / (16 * 38400)) = int(81.38020833) 
  UART1_FBRD_R = 33;                     // FBRD = int(0.38020833 * 64 + 0.05) = int(24)						
                                        // 8 bit word length (no parity bits, one stop bit, FIFOs)
  UART1_LCRH_R = 0x70;
  UART1_CTL_R |= UART_CTL_UARTEN;       // enable UART
